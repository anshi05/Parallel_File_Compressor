...
namespace {
struct qt_meta_stringdata_CompressorSplashScreen_t {
    uint offsetsAndSizes[2];
    char stringdata0[23];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CompressorSplashScreen_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CompressorSplashScreen_t qt_meta_stringdata_CompressorSplashScreen = {
    {
        QT_MOC_LITERAL(0, 22)   // "CompressorSplashScreen"
    },
...
Q_CONSTINIT static const uint qt_meta_data_CompressorSplashScreen[] = {
...
Q_CONSTINIT const QMetaObject CompressorSplashScreen::staticMetaObject = { {
    ...
    qt_meta_stringdata_CompressorSplashScreen.offsetsAndSizes,
    qt_meta_data_CompressorSplashScreen,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CompressorSplashScreen_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<CompressorSplashScreen, std::true_type>
    >,
    nullptr
} };
...
void *CompressorSplashScreen::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CompressorSplashScreen.stringdata0))
