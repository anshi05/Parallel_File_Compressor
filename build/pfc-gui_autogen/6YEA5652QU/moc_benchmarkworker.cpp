...
namespace {
struct qt_meta_tag_ZN15BenchmarkWorkerE_t {};
} // unnamed namespace

template <> constexpr inline auto BenchmarkWorker::qt_create_metaobjectdata<qt_meta_tag_ZN15BenchmarkWorkerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SignalData<void(double, double, double, double, uint64_t, uint64_t)>(4, 2, QMC::AccessPublic, QMetaType::Void, {{
    ...
    return QtMocHelpers::metaObjectData<BenchmarkWorker, qt_meta_tag_ZN15BenchmarkWorkerE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject BenchmarkWorker::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN15BenchmarkWorkerE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN15BenchmarkWorkerE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN15BenchmarkWorkerE_t>.metaTypes,
    nullptr
} };
...
void BenchmarkWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (BenchmarkWorker::*)(const QString & )>(_a, &BenchmarkWorker::progressUpdated, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (BenchmarkWorker::*)(double , double , double , double , uint64_t , uint64_t )>(_a, &BenchmarkWorker::benchmarkFinished, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (BenchmarkWorker::*)(const QString & )>(_a, &BenchmarkWorker::errorOccurred, 2))
            return;
    }
}
...
void *BenchmarkWorker::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN15BenchmarkWorkerE_t>.strings))
